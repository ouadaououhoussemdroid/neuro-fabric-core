...
_The primary benchmark used throughout the project is **BNCI2014_001** (BCI‑IV‑2a)._
...
_This discovery document captures the current state of the EEG data pipeline, preprocessing steps, and evaluation tooling. It deliberately avoids adding any new evaluation code – the next phase will instantiate the above workflow to compute the required quality metrics and compare PCA‑legacy versus EEGConformer embeddings._
