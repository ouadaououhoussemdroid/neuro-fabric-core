...
const AuthenticatedDashboardAnalysesRoute = AuthenticatedDashboardAnalysesRouteImport.update({
  id: '/analyses',
  path: '/analyses',
  getParentRoute: () => AuthenticatedDashboardRoute,
} as any)
const AuthenticatedDashboardResearcherRoute = AuthenticatedDashboardResearcherRouteImport.update({
  id: '/researcher',
  path: '/researcher',
  getParentRoute: () => AuthenticatedDashboardRoute,
} as any)
const AuthenticatedDashboardIndividualRoute = AuthenticatedDashboardIndividualRouteImport.update({
  id: '/individual',
  path: '/individual',
  getParentRoute: () => AuthenticatedDashboardRoute,
} as any)
const AuthenticatedDashboardEnterpriseRoute = AuthenticatedDashboardEnterpriseRouteImport.update({
  id: '/enterprise',
  path: '/enterprise',
  getParentRoute: () => AuthenticatedDashboardRoute,
} as any)
