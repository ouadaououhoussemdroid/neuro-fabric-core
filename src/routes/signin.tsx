  ...
  return (
    <SiteShell>
      <div className="mx-auto max-w-md px-4 py-20">
        ...
        <p className="mt-2 text-sm text-muted-foreground">Sign in to access your NeuroWeave dashboard.</p>
        ...
        <GlassCard className="mt-8 space-y-4">
          ...
          <form onSubmit={onSubmit} className="space-y-3">
            ...
            <button type="submit" disabled={loading} className="w-full rounded-md bg-neuro-gradient px-4 py-2.5 text-sm font-medium text-background glow disabled:opacity-60">
