"""Export the v3 fine-tuned EEGConformer (30 subjects) to ONNX with parity verification."""
...
checkpoint_path = "training/artefacts/eegconformer-physionet-v3/eegconformer.pt"
out_path = "training/artefacts/eegconformer-physionet-v3/eegconformer_finetuned.onnx"
...
print(f"[export] Loaded {len(result)} keys — strict=True OK")
model.eval()
...
# ─── Update train_history.json ────────────────────────────────────────────────
hist_path = Path("training/artefacts/eegconformer-physionet-v3/train_history.json")
if hist_path.exists():
