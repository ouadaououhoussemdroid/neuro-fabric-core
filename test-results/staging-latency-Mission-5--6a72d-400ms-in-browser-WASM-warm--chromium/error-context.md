...
- Name: staging-latency.test.ts >> Mission 5: Staging latency + fallback-rate validation (real browser WASM) >> Group 1: P95/P50 latency gate (< 600ms / < 400ms) for each model >> [EEGConformer v2] P95 latency < 600ms, P50 < 400ms in browser WASM (warm)
